        ...
        <section id="about" className="p-5 bg-dark d-flex justify-content-center" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out">
            <div className="row d-flex text-light align-items-center" style={{ maxWidth: '1400px' }}>
                <div className="col-lg-9" data-aos="fade-up" data-aos-duration="1200" data-aos-easing="ease-in-out">
                    ...
                    <p>Hi, my name is Muhammed Šehić, a first-year student at the <a href="https://www.etf.unsa.ba/" target="_blank" className="text-danger">Faculty of Electrical Engineering, Sarajevo</a>, Software Development. I was born in 2003 in a cold December, so every year in the same month I have to listen to <a href="https://youtu.be/lqvYdYlSC64" target="_blank" className="text-danger">this song</a>.</p>
                    <p>I have been interested in technology, electricity, electronics, and video games from a young age! All these factors, and a few more, influenced my decision to attend <a href="https://etssa.edu.ba/" target="_blank" className="text-danger">this high school</a> - a decision I have never regretted.</p>
                    ...
                    <p title="This sentence has remained since the very beginning of my portfolio text, so let it stay">Although I was born after certain musical hits, it doesn&apos;t stop me from listening to and enjoying them. Most of them are artists who had contracts with the Yugoslav giant called <a href="https://youtu.be/tvHfGBrrUVE" target="_blank" className="text-danger">Studio MMI - Južni Vetar</a>. <br />But if you ask for my favourite artist, it is definitely this <a href="https://youtu.be/loV30grvx4I" target="_blank" className="text-danger">Legend</a>.</p>
                    <p>At the time of my birth, <a href="https://youtu.be/4XvoXmcmVyQ" target="_blank" className="text-danger">this popular single</a> was out. Ironically, I was born during the same time in the type of vehicle as in the song.</p>
                    <p>If you&apos;d like to get in touch, you can do so in several ways depending on what you need! Contact links are available at the contact page.</p>
